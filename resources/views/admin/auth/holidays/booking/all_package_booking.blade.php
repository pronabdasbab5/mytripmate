  ...
  <!-- Modal -->
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>All Package Booking</h2>
            <a href="{{ route('admin.p_booking', ['status' => 1]) }}" style="float: right; font-weight: bolder; font-size: 18px;">New Booking List</a>
            <div class="clearfix"></div>
          </div>
            <div class="x_content"><br />
                <table id="all_package_booking" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th>Sl No</th>
...
$(document).ready(function(){
    ...
    $('#all_package_booking').DataTable({

        "processing": true,
        "serverSide": true,
        "ajax":{
            "url": "{{ url('/admin/all_package_booking_data') }}",
            "dataType": "json",
            "type": "POST",
            "data":{ 
                _token  : "{{csrf_token()}}"
