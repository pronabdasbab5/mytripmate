      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content"><br />
            ...
            <form method="POST" autocomplete="off" action="{{ route('admin.add_p_hotel') }}" class="form-horizontal form-label-left">
                @csrf
              ...
              <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <input type="text" name="hotel_name" class="form-control col-md-7 col-xs-12 form-text-element" placeholder="Enter Hotel Name">
                    @error('hotel_name')
                        {{ $message }}
                    @enderror
                </div>
               ...
               <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <textarea name="hotel_address" class="form-control col-md-7 col-xs-12 form-text-element ckeditor_textarea" placeholder="Hotel Address"></textarea>
                  @error('hotel_address')
                        {{ $message }}
                    @enderror
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <input type="number" name="price" step="0.01" class="form-control col-md-7 col-xs-12 form-text-element" placeholder="Enter Price">
                    @error('price')
                        {{ $message }}
                    @enderror
                </div>
              ...
              <div class="ln_solid"></div>
                <div class="form-group">
                  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <button type="submit" name="submit" class="btn btn-primary form-text-element">Add Hotel</button>
                  </div>
                </div>
            </form>
